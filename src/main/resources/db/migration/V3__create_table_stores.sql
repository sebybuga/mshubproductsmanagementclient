...
INSERT INTO `stores` (`id`, `storeName`, `zipCode`, `address`, `city`,`country`, `createdBy`, `createdAt`) VALUES
	(1, 'Tribeca paint', '10013', '217 W Broadway', 'New York', 'USA', 'test6', now()),
	(2, 'Chinatown Building Supply Inc', '10013', '72 Walker St', 'New York', 'USA', 'test6', now()),
	(3, 'Salem St True Value', '021013', '89 Salem St', 'Boston', 'USA', 'test6', now()),
	(4, 'Charles Street Supply', '021014', '54 Charles St', 'Boston', 'USA', 'test6', now());